#ifndef __OpenViBEPlugins_BoxAlgorithm_ProcessML_H__
#define __OpenViBEPlugins_BoxAlgorithm_ProcessML_H__
...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		class CBoxAlgorithmProcessML : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
		...
		protected:
			...
			std::vector < OpenViBEToolkit::TDecoder < CBoxAlgorithmProcessML >* > m_vDecoders;
			std::vector < OpenViBEToolkit::TEncoder < CBoxAlgorithmProcessML >* > m_vEncoders;
		...
		class CBoxAlgorithmProcessMLListener : public OpenViBEToolkit::TBoxListener < OpenViBE::Plugins::IBoxListener >
		{
		public:
		...
		class CBoxAlgorithmProcessMLDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:
			...
			virtual OpenViBE::CString getShortDescription(void) const    { return OpenViBE::CString("Make all the process to load and predict with a machine learning model."); }
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Python::CBoxAlgorithmProcessML; }
			...
			virtual OpenViBE::boolean getBoxPrototype(OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
                ...
                rBoxAlgorithmPrototype.addSetting("Model filename", OV_TypeId_Filename, "");
                rBoxAlgorithmPrototype.addSetting("Predictions filename", OV_TypeId_Filename, "");
...
#endif // __OpenViBEPlugins_BoxAlgorithm_ProcessML_H__
