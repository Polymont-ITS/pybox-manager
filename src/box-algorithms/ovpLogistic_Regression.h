...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		public:
			...
			OpenViBE::CString getName() const override { return OpenViBE::CString("Logistic Regression"); }
			...
			OpenViBE::CString getShortDescription() const override { return OpenViBE::CString("Train a Logistic Regression Classifier from Sklearn."); }
			...
			OpenViBE::CIdentifier getCreatedClass() const override { return OVP_ClassId_BoxAlgorithm_Logistic_Regression; }
			OpenViBE::Plugins::IPluginObject* create() override { return new CBoxAlgorithmLogistic_Regression; }
			OpenViBE::Plugins::IBoxListener* createBoxListener() const override { return new CBoxAlgorithmLogistic_RegressionListener; }
