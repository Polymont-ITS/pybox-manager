...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		public:
			...
			virtual OpenViBE::CString getName() const { return OpenViBE::CString("Logistic Regression"); }
			...
			virtual OpenViBE::CString getShortDescription() const { return OpenViBE::CString("Train a Logistic Regression Classifier from Sklearn."); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass() const { return OVP_ClassId_BoxAlgorithm_Logistic_Regression; }
			virtual OpenViBE::Plugins::IPluginObject* create() { return new CBoxAlgorithmLogistic_Regression; }
			virtual OpenViBE::Plugins::IBoxListener* createBoxListener() const { return new CBoxAlgorithmLogistic_RegressionListener; }
