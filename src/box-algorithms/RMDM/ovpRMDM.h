#ifndef __OpenViBEPlugins_BoxAlgorithm_RMDM_H__
#define __OpenViBEPlugins_BoxAlgorithm_RMDM_H__
...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		class CBoxAlgorithmRMDM : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
		...
		protected:
			...
			std::vector < OpenViBEToolkit::TDecoder < CBoxAlgorithmRMDM >* > m_vDecoders;
			std::vector < OpenViBEToolkit::TEncoder < CBoxAlgorithmRMDM >* > m_vEncoders;
		...
		class CBoxAlgorithmRMDMListener : public OpenViBEToolkit::TBoxListener < OpenViBE::Plugins::IBoxListener >
		{
		public:
		...
		class CBoxAlgorithmRMDMDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Python::CBoxAlgorithmRMDM; }
			...
			virtual OpenViBE::boolean getBoxPrototype(OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
                ...
                rBoxAlgorithmPrototype.addSetting("Classifier", OVPoly_ClassId_Classifier_Algorithm, "Riemann Minimum Distance to Mean");
                ...
                rBoxAlgorithmPrototype.addSetting("Discriminator", OVPoly_ClassId_Classifier_Algorithm, "None");
...
#endif // __OpenViBEPlugins_BoxAlgorithm_RMDM_H__
