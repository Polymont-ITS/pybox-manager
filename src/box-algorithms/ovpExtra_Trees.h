...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		public:
			...
			virtual OpenViBE::CString getName() const { return OpenViBE::CString("Extra Trees"); }
			...
			virtual OpenViBE::CString getShortDescription() const { return OpenViBE::CString("Train an Extra Trees Classifier from Sklearn."); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass() const { return OVP_ClassId_BoxAlgorithm_Extra_Trees; }
			virtual OpenViBE::Plugins::IPluginObject* create() { return new CBoxAlgorithmExtra_Trees; }
			virtual OpenViBE::Plugins::IBoxListener* createBoxListener() const { return new CBoxAlgorithmExtra_TreesListener; }
