...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		{
		public:
			CBoxAlgorithmExtra_Trees() { m_sScriptFilename = "../../extras/contrib/applications/developer-tools/pybox-manager/ScriptBox/TrainerML.py";}
		...
		public:
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new CBoxAlgorithmExtra_Trees; }
