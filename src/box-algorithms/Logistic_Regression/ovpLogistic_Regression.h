#ifndef __OpenViBEPlugins_BoxAlgorithm_Logistic_Regression_H__
#define __OpenViBEPlugins_BoxAlgorithm_Logistic_Regression_H__
...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		class CBoxAlgorithmLogistic_Regression : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
		...
		protected:
			...
			std::vector < OpenViBEToolkit::TDecoder < CBoxAlgorithmLogistic_Regression >* > m_vDecoders;
			std::vector < OpenViBEToolkit::TEncoder < CBoxAlgorithmLogistic_Regression >* > m_vEncoders;
		...
		class CBoxAlgorithmLogistic_RegressionListener : public OpenViBEToolkit::TBoxListener < OpenViBE::Plugins::IBoxListener >
		{
		public:
		...
		class CBoxAlgorithmLogistic_RegressionDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:
			...
			virtual OpenViBE::CString getShortDescription(void) const    { return OpenViBE::CString("Train a Logistic Regression classifier from Sklearn."); }
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Python::CBoxAlgorithmLogistic_Regression; }
			...
			virtual OpenViBE::boolean getBoxPrototype(OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
                ...
                rBoxAlgorithmPrototype.addSetting("Classifier", OVPoly_ClassId_Classifier_Algorithm, "Logistic Regression");
                rBoxAlgorithmPrototype.addSetting("Test set share", OV_TypeId_Float, "0.2");
                rBoxAlgorithmPrototype.addSetting("Labels", OV_TypeId_String, "gauche, droite");
                rBoxAlgorithmPrototype.addSetting("penalty", OVPoly_ClassId_Penalty, "l2");
                rBoxAlgorithmPrototype.addSetting("dual", OV_TypeId_Boolean, "false");
                ...
                rBoxAlgorithmPrototype.addSetting("intercept_scaling", OV_TypeId_Float, "1");
                rBoxAlgorithmPrototype.addSetting("random_state", OV_TypeId_String, "None");
                rBoxAlgorithmPrototype.addSetting("solver", OVPoly_ClassId_Log_reg_solver, "lbfgs");
                rBoxAlgorithmPrototype.addSetting("max_iter", OV_TypeId_Integer, "100");
                ...
                rBoxAlgorithmPrototype.addSetting("n_jobs", OV_TypeId_String, "None");
                rBoxAlgorithmPrototype.addSetting("multi_class", OVPoly_ClassId_Log_reg_multi_class, "auto");
                rBoxAlgorithmPrototype.addSetting("C", OV_TypeId_Float, "1.0");
...
#endif // __OpenViBEPlugins_BoxAlgorithm_Logistic_Regression_H__
