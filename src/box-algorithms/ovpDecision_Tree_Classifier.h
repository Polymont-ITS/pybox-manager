...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		public:
			...
			OpenViBE::CString getName() const override { return OpenViBE::CString("Decision Tree Classifier"); }
			...
			OpenViBE::CString getShortDescription() const override { return OpenViBE::CString("Train a Decision Tree Classifier from Sklearn."); }
			...
			OpenViBE::CIdentifier getCreatedClass() const override { return OVP_ClassId_BoxAlgorithm_Decision_Tree_Classifier; }
			OpenViBE::Plugins::IPluginObject* create() override { return new CBoxAlgorithmDecision_Tree_Classifier; }
			OpenViBE::Plugins::IBoxListener* createBoxListener() const override { return new CBoxAlgorithmDecision_Tree_ClassifierListener; }
