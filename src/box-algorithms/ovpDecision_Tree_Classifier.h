...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		{
		public:
			CBoxAlgorithmDecision_Tree_Classifier() { m_sScriptFilename = "../../extras/contrib/applications/developer-tools/pybox-manager/ScriptBox/TrainerML.py";}
		...
		public:
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new CBoxAlgorithmDecision_Tree_Classifier; }
