#ifndef __OpenViBEPlugins_BoxAlgorithm_GaussianNB_H__
#define __OpenViBEPlugins_BoxAlgorithm_GaussianNB_H__
...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		class CBoxAlgorithmGaussianNB : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
		...
		protected:
			...
			std::vector < OpenViBEToolkit::TDecoder < CBoxAlgorithmGaussianNB >* > m_vDecoders;
			std::vector < OpenViBEToolkit::TEncoder < CBoxAlgorithmGaussianNB >* > m_vEncoders;
		...
		class CBoxAlgorithmGaussianNBListener : public OpenViBEToolkit::TBoxListener < OpenViBE::Plugins::IBoxListener >
		{
		public:
		...
		class CBoxAlgorithmGaussianNBDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Python::CBoxAlgorithmGaussianNB; }
			...
			virtual OpenViBE::boolean getBoxPrototype(OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
                ...
                rBoxAlgorithmPrototype.addSetting("Classifier", OVPoly_ClassId_Classifier_Algorithm, "Gaussian Naive Bayes");
                ...
                rBoxAlgorithmPrototype.addSetting("var_smoothing", OV_TypeId_Float, "0.000000001");
...
#endif // __OpenViBEPlugins_BoxAlgorithm_GaussianNB_H__
