...
namespace OpenViBE
{
	namespace Plugins
	{
		namespace PyBox
		{
			...
			{
			public:
				CBoxAlgorithmNearestCentroid() { m_script = "../../extras/contrib/applications/developer-tools/pybox-manager/ScriptBox/TrainerML.py"; }
				_IsDerivedFromClass_Final_(OpenViBE::Toolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, OVP_ClassId_BoxAlgorithm_NearestCentroid)
			};

			class CBoxAlgorithmNearestCentroidListener final : public Toolkit::TBoxListener<IBoxListener>
			{
			public:
			...
			class CBoxAlgorithmNearestCentroidDesc final : virtual public IBoxAlgorithmDesc
			{
			public:

				void release() override { }

				CString getName() const override { return CString("NearestCentroid"); }
				...
				CString getShortDescription() const override { return CString("Train a Nearest Centroid Classifier from Sklearn."); }
				...
				CIdentifier getCreatedClass() const override { return OVP_ClassId_BoxAlgorithm_NearestCentroid; }
				IPluginObject* create() override { return new CBoxAlgorithmNearestCentroid; }
				IBoxListener* createBoxListener() const override { return new CBoxAlgorithmNearestCentroidListener; }
