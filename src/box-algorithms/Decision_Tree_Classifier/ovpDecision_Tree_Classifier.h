#ifndef __OpenViBEPlugins_BoxAlgorithm_Decision_Tree_Classifier_H__
#define __OpenViBEPlugins_BoxAlgorithm_Decision_Tree_Classifier_H__
...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		class CBoxAlgorithmDecision_Tree_Classifier : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
		...
		protected:
			...
			std::vector < OpenViBEToolkit::TDecoder < CBoxAlgorithmDecision_Tree_Classifier >* > m_vDecoders;
			std::vector < OpenViBEToolkit::TEncoder < CBoxAlgorithmDecision_Tree_Classifier >* > m_vEncoders;
		...
		class CBoxAlgorithmDecision_Tree_ClassifierListener : public OpenViBEToolkit::TBoxListener < OpenViBE::Plugins::IBoxListener >
		{
		public:
		...
		class CBoxAlgorithmDecision_Tree_ClassifierDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }

			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("Decision Tree Classifier"); }
			...
			virtual OpenViBE::CString getShortDescription(void) const    { return OpenViBE::CString("Train a Decision Tree Classifier from Sklearn."); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_BoxAlgorithm_Decision_Tree_Classifier; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Python::CBoxAlgorithmDecision_Tree_Classifier; }
			virtual OpenViBE::Plugins::IBoxListener* createBoxListener(void) const               { return new CBoxAlgorithmDecision_Tree_ClassifierListener; }
			...
			virtual OpenViBE::boolean getBoxPrototype(OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
                ...
                rBoxAlgorithmPrototype.addSetting("Classifier", OVPoly_ClassId_Classifier_Algorithm, "Decision Tree Classifier");
                ...
                rBoxAlgorithmPrototype.addSetting("splitter", OVPoly_ClassId_DecisionTree_splitter, "best");
                rBoxAlgorithmPrototype.addSetting("max_depth", OV_TypeId_String, "None");
                rBoxAlgorithmPrototype.addSetting("min_samples_split", OV_TypeId_String, "2");
                ...
                rBoxAlgorithmPrototype.addSetting("max_features", OV_TypeId_String, "None");
...
#endif // __OpenViBEPlugins_BoxAlgorithm_Decision_Tree_Classifier_H__
