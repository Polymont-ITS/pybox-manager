#ifndef __OpenViBEPlugins_BoxAlgorithm_TrainerML_H__
#define __OpenViBEPlugins_BoxAlgorithm_TrainerML_H__
...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		class CBoxAlgorithmTrainerML : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
			...
			_IsDerivedFromClass_Final_(OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, OVP_ClassId_BoxAlgorithm_TrainerML);
		...
		protected:
			...
			std::vector < OpenViBEToolkit::TDecoder < CBoxAlgorithmTrainerML >* > m_vDecoders;
			std::vector < OpenViBEToolkit::TEncoder < CBoxAlgorithmTrainerML >* > m_vEncoders;
		...
		class CBoxAlgorithmTrainerMLListener : public OpenViBEToolkit::TBoxListener < OpenViBE::Plugins::IBoxListener >
		{
		public:
		...
		class CBoxAlgorithmTrainerMLDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }

			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("TrainerML"); }
			...
			virtual OpenViBE::CString getShortDescription(void) const    { return OpenViBE::CString("Create a machine learning model."); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_BoxAlgorithm_TrainerML; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Python::CBoxAlgorithmTrainerML; }
			virtual OpenViBE::Plugins::IBoxListener* createBoxListener(void) const               { return new CBoxAlgorithmTrainerMLListener; }
			...
			virtual OpenViBE::boolean getBoxPrototype(OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
                ...
                rBoxAlgorithmPrototype.addSetting("Classifier", OVPoly_ClassId_Classifier_Algorithm, "");
			...
			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_BoxAlgorithm_TrainerMLDesc);
		};
	};
};
...
#endif // __OpenViBEPlugins_BoxAlgorithm_TrainerML_H__
