...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		public:
			...
			virtual OpenViBE::CString getName() const { return OpenViBE::CString("SVM"); }
			...
			virtual OpenViBE::CString getShortDescription() const { return OpenViBE::CString("Train a Support Vector Machine Classifier from Sklearn."); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass() const { return OVP_ClassId_BoxAlgorithm_SVM; }
			virtual OpenViBE::Plugins::IPluginObject* create() { return new CBoxAlgorithmSVM; }
			virtual OpenViBE::Plugins::IBoxListener* createBoxListener() const { return new CBoxAlgorithmSVMListener; }
