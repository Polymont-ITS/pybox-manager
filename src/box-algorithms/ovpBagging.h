...
namespace OpenViBE
{
	namespace Plugins
	{
		namespace PyBox
		{
			...
			class CBoxAlgorithmBaggingListener final : public Toolkit::TBoxListener<IBoxListener>
			{
			public:
			...
			class CBoxAlgorithmBaggingDesc final : virtual public IBoxAlgorithmDesc
			{
			public:

				void release() override { }

				CString getName() const override { return CString("Bagging"); }
				...
				CString getShortDescription() const override { return CString("Train a Bagging Classifier from Sklearn."); }
				...
				CIdentifier getCreatedClass() const override { return OVP_ClassId_BoxAlgorithm_Bagging; }
				IPluginObject* create() override { return new CBoxAlgorithmBagging; }
				IBoxListener* createBoxListener() const override { return new CBoxAlgorithmBaggingListener; }
