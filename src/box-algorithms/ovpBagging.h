...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		public:
			...
			OpenViBE::CString getName() const override { return OpenViBE::CString("Bagging"); }
			...
			OpenViBE::CString getShortDescription() const override { return OpenViBE::CString("Train a Bagging Classifier from Sklearn."); }
			...
			OpenViBE::CIdentifier getCreatedClass() const override { return OVP_ClassId_BoxAlgorithm_Bagging; }
			OpenViBE::Plugins::IPluginObject* create() override { return new CBoxAlgorithmBagging; }
			OpenViBE::Plugins::IBoxListener* createBoxListener() const override { return new CBoxAlgorithmBaggingListener; }
