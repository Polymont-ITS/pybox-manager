...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		public:
			...
			virtual OpenViBE::CString getShortDescription(void) const    { return OpenViBE::CString("Train an Multi-Layers Perceptron Classifier from Sklearn."); }
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new CBoxAlgorithmMLP; }
