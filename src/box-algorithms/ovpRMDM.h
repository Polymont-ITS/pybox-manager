...
namespace OpenViBE
{
	namespace Plugins
	{
		namespace PyBox
		{
			...
			{
			public:
				CBoxAlgorithmRMDM() { m_script = Directories::getDataDir() + "/plugins/python3/pybox/TrainerML.py"; }
				_IsDerivedFromClass_Final_(OpenViBE::Toolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, OVP_ClassId_BoxAlgorithm_RMDM)
			};

			class CBoxAlgorithmRMDMListener final : public Toolkit::TBoxListener<IBoxListener>
			{
			public:
			...
			class CBoxAlgorithmRMDMDesc final : virtual public IBoxAlgorithmDesc
			{
			public:

				void release() override { }

				CString getName() const override { return CString("RMDM"); }
				...
				CString getShortDescription() const override { return CString("Riemann minimum distance to mean classifier."); }
				...
				CIdentifier getCreatedClass() const override { return OVP_ClassId_BoxAlgorithm_RMDM; }
				IPluginObject* create() override { return new CBoxAlgorithmRMDM; }
				IBoxListener* createBoxListener() const override { return new CBoxAlgorithmRMDMListener; }
