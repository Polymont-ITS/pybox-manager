...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		public:
			...
			virtual OpenViBE::CString getName() const { return OpenViBE::CString("RMDM"); }
			...
			virtual OpenViBE::CString getShortDescription() const { return OpenViBE::CString("Riemann minimum distance to mean classifier."); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass() const { return OVP_ClassId_BoxAlgorithm_RMDM; }
			virtual OpenViBE::Plugins::IPluginObject* create() { return new CBoxAlgorithmRMDM; }
			virtual OpenViBE::Plugins::IBoxListener* createBoxListener() const { return new CBoxAlgorithmRMDMListener; }
