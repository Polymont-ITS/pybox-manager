#ifndef __OpenViBEPlugins_BoxAlgorithm_SVM_H__
#define __OpenViBEPlugins_BoxAlgorithm_SVM_H__
...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		class CBoxAlgorithmSVM : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
		...
		protected:
			...
			std::vector < OpenViBEToolkit::TDecoder < CBoxAlgorithmSVM >* > m_vDecoders;
			std::vector < OpenViBEToolkit::TEncoder < CBoxAlgorithmSVM >* > m_vEncoders;
		...
		class CBoxAlgorithmSVMListener : public OpenViBEToolkit::TBoxListener < OpenViBE::Plugins::IBoxListener >
		{
		public:
		...
		class CBoxAlgorithmSVMDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Python::CBoxAlgorithmSVM; }
			...
			virtual OpenViBE::boolean getBoxPrototype(OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
                ...
                rBoxAlgorithmPrototype.addSetting("Classifier", OVPoly_ClassId_Classifier_Algorithm, "Support Vector Machine");
                ...
                rBoxAlgorithmPrototype.addSetting("loss", OVPoly_ClassId_SVM_Loss, "squared_hinge");
                rBoxAlgorithmPrototype.addSetting("dual", OV_TypeId_Boolean, "true");
                rBoxAlgorithmPrototype.addSetting("tol", OV_TypeId_Float, "0.0001");
                rBoxAlgorithmPrototype.addSetting("C", OV_TypeId_Float, "1.0");
                rBoxAlgorithmPrototype.addSetting("multi_class", OVPoly_ClassId_SVM_MultiClass, "ovr");
...
#endif // __OpenViBEPlugins_BoxAlgorithm_SVM_H__
