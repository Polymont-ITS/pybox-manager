#ifndef __OpenViBEPlugins_BoxAlgorithm_NearestCentroid_H__
#define __OpenViBEPlugins_BoxAlgorithm_NearestCentroid_H__
...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		class CBoxAlgorithmNearestCentroid : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
		...
		protected:
			...
			std::vector < OpenViBEToolkit::TDecoder < CBoxAlgorithmNearestCentroid >* > m_vDecoders;
			std::vector < OpenViBEToolkit::TEncoder < CBoxAlgorithmNearestCentroid >* > m_vEncoders;
		...
		class CBoxAlgorithmNearestCentroidListener : public OpenViBEToolkit::TBoxListener < OpenViBE::Plugins::IBoxListener >
		{
		public:
		...
		class CBoxAlgorithmNearestCentroidDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Python::CBoxAlgorithmNearestCentroid; }
			...
			virtual OpenViBE::boolean getBoxPrototype(OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
                ...
                rBoxAlgorithmPrototype.addSetting("Classifier", OVPoly_ClassId_Classifier_Algorithm, "Nearest Centroid");
                ...
                rBoxAlgorithmPrototype.addSetting("metric", OVPoly_ClassId_Metric, "euclidean");
                rBoxAlgorithmPrototype.addSetting("shrink_threshold", OV_TypeId_String, "");
...
#endif // __OpenViBEPlugins_BoxAlgorithm_NearestCentroid_H__
