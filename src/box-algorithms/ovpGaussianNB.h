...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		public:
			...
			OpenViBE::CString getName() const override { return OpenViBE::CString("GaussianNB"); }
			...
			OpenViBE::CString getShortDescription() const override { return OpenViBE::CString("Train a Gaussian Naive Bayes classifier from Sklearn."); }
			...
			OpenViBE::CIdentifier getCreatedClass() const override { return OVP_ClassId_BoxAlgorithm_GaussianNB; }
			OpenViBE::Plugins::IPluginObject* create() override { return new CBoxAlgorithmGaussianNB; }
			OpenViBE::Plugins::IBoxListener* createBoxListener() const override { return new CBoxAlgorithmGaussianNBListener; }
