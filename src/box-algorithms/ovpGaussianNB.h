...
namespace OpenViBE
{
	namespace Plugins
	{
		namespace PyBox
		{
			...
			{
			public:
				CBoxAlgorithmGaussianNB() { m_script = "../../extras/contrib/applications/developer-tools/pybox-manager/ScriptBox/TrainerML.py"; }
				_IsDerivedFromClass_Final_(OpenViBE::Toolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, OVP_ClassId_BoxAlgorithm_GaussianNB)
			};

			class CBoxAlgorithmGaussianNBListener final : public Toolkit::TBoxListener<IBoxListener>
			{
			public:
			...
			class CBoxAlgorithmGaussianNBDesc final : virtual public IBoxAlgorithmDesc
			{
			public:

				void release() override { }

				CString getName() const override { return CString("GaussianNB"); }
				...
				CString getShortDescription() const override { return CString("Train a Gaussian Naive Bayes classifier from Sklearn."); }
				...
				CIdentifier getCreatedClass() const override { return OVP_ClassId_BoxAlgorithm_GaussianNB; }
				IPluginObject* create() override { return new CBoxAlgorithmGaussianNB; }
				IBoxListener* createBoxListener() const override { return new CBoxAlgorithmGaussianNBListener; }
