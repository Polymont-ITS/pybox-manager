...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		{
		public:
			CBoxAlgorithmRiemann_Tangent_Space() { m_sScriptFilename = "../../extras/contrib/applications/developer-tools/pybox-manager/ScriptBox/TrainerML.py";}
		...
		public:
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new CBoxAlgorithmRiemann_Tangent_Space; }
