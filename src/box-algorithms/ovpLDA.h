...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		{
		public:
			CBoxAlgorithmLDA() { m_sScriptFilename = "../../extras/contrib/applications/developer-tools/pybox-manager/ScriptBox/TrainerML.py";}
		...
		public:
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new CBoxAlgorithmLDA; }
