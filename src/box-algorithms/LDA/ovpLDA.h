#ifndef __OpenViBEPlugins_BoxAlgorithm_LDA_H__
#define __OpenViBEPlugins_BoxAlgorithm_LDA_H__
...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		class CBoxAlgorithmLDA : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
		...
		protected:
			...
			std::vector < OpenViBEToolkit::TDecoder < CBoxAlgorithmLDA >* > m_vDecoders;
			std::vector < OpenViBEToolkit::TEncoder < CBoxAlgorithmLDA >* > m_vEncoders;
		...
		class CBoxAlgorithmLDAListener : public OpenViBEToolkit::TBoxListener < OpenViBE::Plugins::IBoxListener >
		{
		public:
		...
		class CBoxAlgorithmLDADesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }

			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("LDA"); }
			...
			virtual OpenViBE::CString getShortDescription(void) const    { return OpenViBE::CString("Train a Linear Discriminant Analysis classifier from Sklearn."); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_BoxAlgorithm_LDA; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Python::CBoxAlgorithmLDA; }
			virtual OpenViBE::Plugins::IBoxListener* createBoxListener(void) const               { return new CBoxAlgorithmLDAListener; }
			...
			virtual OpenViBE::boolean getBoxPrototype(OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
                ...
                rBoxAlgorithmPrototype.addSetting("Classifier", OVPoly_ClassId_Classifier_Algorithm, "Linear Discriminant Analysis");
                rBoxAlgorithmPrototype.addSetting("Discriminator", OV_TypeId_String, "");
                rBoxAlgorithmPrototype.addSetting("Test set share", OV_TypeId_String, "0.2");
                rBoxAlgorithmPrototype.addSetting("Labels", OV_TypeId_String, "");
                rBoxAlgorithmPrototype.addSetting("solver", OVPoly_ClassId_LDA_solver, "svd");
                rBoxAlgorithmPrototype.addSetting("n_components", OV_TypeId_String, "");
...
#endif // __OpenViBEPlugins_BoxAlgorithm_LDA_H__
