...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		{
		public:
			CBoxAlgorithmRandom_Forest() { m_script = "../../extras/contrib/applications/developer-tools/pybox-manager/ScriptBox/TrainerML.py"; }
		...
		public:
			...
			OpenViBE::CString getName() const override { return OpenViBE::CString("Random Forest"); }
			...
			OpenViBE::CString getShortDescription() const override { return OpenViBE::CString("Train a Random Forest Classifier from Sklearn."); }
			...
			OpenViBE::CIdentifier getCreatedClass() const override { return OVP_ClassId_BoxAlgorithm_Random_Forest; }
			OpenViBE::Plugins::IPluginObject* create() override { return new CBoxAlgorithmRandom_Forest; }
			OpenViBE::Plugins::IBoxListener* createBoxListener() const override { return new CBoxAlgorithmRandom_ForestListener; }
