...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		public:
			...
			virtual OpenViBE::CString getName() const { return OpenViBE::CString("Random Forest"); }
			...
			virtual OpenViBE::CString getShortDescription() const { return OpenViBE::CString("Train a Random Forest Classifier from Sklearn."); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass() const { return OVP_ClassId_BoxAlgorithm_Random_Forest; }
			virtual OpenViBE::Plugins::IPluginObject* create() { return new CBoxAlgorithmRandom_Forest; }
			virtual OpenViBE::Plugins::IBoxListener* createBoxListener() const { return new CBoxAlgorithmRandom_ForestListener; }
