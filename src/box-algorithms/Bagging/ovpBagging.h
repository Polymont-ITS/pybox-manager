#ifndef __OpenViBEPlugins_BoxAlgorithm_Bagging_H__
#define __OpenViBEPlugins_BoxAlgorithm_Bagging_H__
...
namespace OpenViBEPlugins
{
	namespace Python
	{
		...
		class CBoxAlgorithmBagging : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
		...
		protected:
			...
			std::vector < OpenViBEToolkit::TDecoder < CBoxAlgorithmBagging >* > m_vDecoders;
			std::vector < OpenViBEToolkit::TEncoder < CBoxAlgorithmBagging >* > m_vEncoders;
		...
		class CBoxAlgorithmBaggingListener : public OpenViBEToolkit::TBoxListener < OpenViBE::Plugins::IBoxListener >
		{
		public:
		...
		class CBoxAlgorithmBaggingDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Python::CBoxAlgorithmBagging; }
			...
			virtual OpenViBE::boolean getBoxPrototype(OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
                ...
                rBoxAlgorithmPrototype.addSetting("Classifier", OVPoly_ClassId_Classifier_Algorithm, "Bagging");
                ...
                rBoxAlgorithmPrototype.addSetting("max_features", OV_TypeId_Float, "1.0");
                rBoxAlgorithmPrototype.addSetting("random_state", OV_TypeId_String, "None");
                rBoxAlgorithmPrototype.addSetting("n_estimators", OV_TypeId_Integer, "10");
                rBoxAlgorithmPrototype.addSetting("bootstrap", OV_TypeId_Boolean, "true");
                rBoxAlgorithmPrototype.addSetting("bootstrap_features", OV_TypeId_Boolean, "false");
...
#endif // __OpenViBEPlugins_BoxAlgorithm_Bagging_H__
