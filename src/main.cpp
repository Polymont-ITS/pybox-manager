...
OVP_Declare_Begin()
		...
		OVP_Declare_New(PyBox::CBoxAlgorithmADADesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmDatasetCreatorDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmSVMDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmSGDDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmRMDMDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmRiemann_Tangent_SpaceDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmRandom_ForestDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmProcessMLDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmNearestCentroidDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmMLPDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmLogistic_RegressionDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmLDADesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmKNearestNeighborsDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmGaussianNBDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmExtra_TreesDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmDecision_Tree_ClassifierDesc);
		OVP_Declare_New(PyBox::CBoxAlgorithmBaggingDesc);
		...
		context.getTypeManager().registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Nearest Neighbors Classifier", 1);
		...
		context.getTypeManager().registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Decision Tree Classifier", 5);
