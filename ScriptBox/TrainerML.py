...
class TrainerML(PolyBox) :
    ...
    def init_params(self):
        ...
        # default settings
        self.std_settings = ['Classifier','Discriminator','Filename to load model from','Test set share','Filename to save configuration to','Filename to save model to','Clock frequency (Hz)','Labels']
