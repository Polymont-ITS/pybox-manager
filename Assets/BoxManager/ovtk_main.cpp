...
//	l_rTypeManager.registerEnumerationEntry(OV_TypeId_MeasurementUnit, "percent", OVTK_UNIT_10_2_Percent);
	...
	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_Classifier_Algorithm, "Classifier_Algorithm");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Nearest Centroid", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Nearest Neighbors Classifier", 1);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Gaussian Naive Bayes", 2);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Stochastic Gradient Descent", 3);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Logistic Regression", 4);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Decision Tree Classifier", 5);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Extra Trees", 6);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Bagging", 7);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Random Forest", 8);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Support Vector Machine", 9);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Linear Discriminant Analysis", 10);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "AdaBoost", 11);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Multi Layer Perceptron", 12);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Riemann Minimum Distance to Mean", 13);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "Riemann Tangent Space", 14);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Classifier_Algorithm, "None", 15);

	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_Knn_Algorithm, "Knn_Algorithm");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Knn_Algorithm, "auto", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Knn_Algorithm, "ball_tree", 1);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Knn_Algorithm, "kd_tree", 2);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Knn_Algorithm, "brute", 3);
	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_Knn_Weights, "Knn_Weights");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Knn_Weights, "uniform", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Knn_Weights, "distance", 1);

	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_Metric, "Metric");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "cityblock", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "cosine", 1);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "euclidean", 2);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "l1", 3);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "l2", 4);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "manhattan", 5);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "braycurtis", 6);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "canberra", 7);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "chebyshev", 8);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "correlation", 9);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "dice", 10);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "hamming", 11);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "jaccard", 12);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "kulsinski", 13);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "minkowski", 14);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "mahalanobis", 15);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "rogerstanimoto", 16);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "russellrao", 17);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "seuclidean", 18);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "sokalmichener", 19);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "sokalsneath", 20);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "sqeuclidean", 21);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Metric, "yule", 22);

	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_Penalty, "Penalty");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Penalty, "l1", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Penalty, "l2", 1);

	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_SVM_Loss, "SVM_Loss");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SVM_Loss, "hinge", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SVM_Loss, "squared_hinge", 1);

	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_SVM_MultiClass, "SVM_MultiClass");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SVM_MultiClass, "ovr", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SVM_MultiClass, "crammer_singer", 1);

	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_Criterion, "Criterion");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Criterion, "gini", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Criterion, "entropy", 1);


	// Logistic regression
	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_Log_reg_solver, "Solver");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Log_reg_solver, "newton-cg", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Log_reg_solver, "lbfgs", 1);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Log_reg_solver, "liblinear", 2);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Log_reg_solver, "sag", 3);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Log_reg_solver, "saga", 4);

	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_Log_reg_multi_class, "Multi_class");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Log_reg_multi_class, "auto", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Log_reg_multi_class, "ovr", 1);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_Log_reg_multi_class, "multinominal", 2);


	// Decision Tree Classifier
	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_DecisionTree_splitter, "Splitter");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_DecisionTree_splitter, "best", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_DecisionTree_splitter, "random", 1);

	// MLP 
	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_MLP_activation, "Activation");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_MLP_activation, "identity", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_MLP_activation, "logistic", 1);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_MLP_activation, "tanh", 2);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_MLP_activation, "relu", 3);

	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_MLP_solver, "Solver");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_MLP_solver, "lbfgs", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_MLP_solver, "sgd", 1);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_MLP_solver, "adam", 2);

	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_MLP_learning_rate, "Learning rate");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_MLP_learning_rate, "constant", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_MLP_learning_rate, "invscaling", 1);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_MLP_learning_rate, "adaptive", 2);

	// SGD
	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_SGD_loss, "Loss");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SGD_loss, "hinge", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SGD_loss, "log", 1);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SGD_loss, "modified_huber", 2);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SGD_loss, "squared_hinge", 3);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SGD_loss, "perceptron", 4);

	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_SGD_learning_rate, "Learning rate");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SGD_learning_rate, "optimal", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SGD_learning_rate, "constant", 1);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SGD_learning_rate, "invscaling", 2);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_SGD_learning_rate, "adaptive", 3);

	// LDA
	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_LDA_solver, "Loss");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_LDA_solver, "svd", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_LDA_solver, "lsqr", 1);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_LDA_solver, "eigen", 2);

	// ADA
	l_rTypeManager.registerEnumerationType(OVPoly_ClassId_ADA_algorithm, "Algorithm");
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_ADA_algorithm, "SAMME", 0);
	l_rTypeManager.registerEnumerationEntry(OVPoly_ClassId_ADA_algorithm, "SAMME.R", 1);
